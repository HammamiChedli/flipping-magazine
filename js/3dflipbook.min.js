...
}, function (module, exports, __webpack_require__) { __webpack_require__(23), module.exports = __webpack_require__(22) }]);
document.addEventListener('DOMContentLoaded', function () {
    function checkForIframe(nbrAttempts = 0, maxAttempts = 100) {
        ...
        if (flipBookContainer && nbrAttempts < maxAttempts) {
            ...
            if (iframe) {
                ...
                if (demoMsgElement) {
                    ...
                    console.log(`Element non trouvé, réessaie dans 300 ms... (tentative ${nbrAttempts + 1})`);
                    setTimeout(() => checkForIframe(nbrAttempts + 1), 300);
                }
            } else {
